  ...
  <div className="relative">
    ...
    <ContentWrapper className="relative z-10 mx-auto flex flex-col gap-8 pt-16">
      ...
      <div className="relative flex items-center justify-center">
        <div className="-translate-y-1/2 absolute top-1/2 left-0 hidden h-[2px] w-8 bg-gradient-to-r from-transparent to-[var(--color-racing-cyan)] sm:block sm:w-12" />
        <h1
          className="animate-fade-in-up px-4 text-center font-bold text-3xl text-white leading-tight sm:px-16 sm:text-4xl lg:text-5xl"
          id={title}
        >
          {title}
        </h1>
        <div className="-translate-y-1/2 absolute top-1/2 right-0 hidden h-[2px] w-8 bg-gradient-to-l from-transparent to-[var(--color-racing-magenta)] sm:block sm:w-12" />
      </div>
